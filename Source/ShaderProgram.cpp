...
{
	uint vs = CompileShader(vShader, ShaderType::Vertex);
	uint fs = CompileShader(fShader, ShaderType::Fragment);
...
uint ShaderProgram::CompileShader(const char* shaderPath, ShaderType shaderType)
{
	uint shader;
